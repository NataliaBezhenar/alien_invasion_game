...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, stats, sb, ai_settings, screen, ship, bullets)
...
def change_fleet_direction (ai_settings, aliens):
    """Reacts on the reaching the edge of the screen by alien"""
    for alien in aliens.sprites():
...
def ship_hit(ai_settings, stats, screen, ship, sb, aliens, bullets):
    if stats.ships_left > 0:
        ...
        reset_game_settings(ai_settings, stats, screen, ship, sb, aliens)


def reset_game_settings(ai_settings, stats, screen, ship, sb, aliens):
